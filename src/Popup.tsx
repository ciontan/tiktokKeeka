...
type PopupProps = {
  ...
  onClose?: () => void; // callback for closing popup
};
...
export default function Popup({
  ...
  const footer = (
    ...
    >
      ...
      >
        <text
          style={{ color: "#fff", fontSize: "14px", fontWeight: 600 as any }}
        >
          Learn more
        </text>
      </view>
      ...
      >
        <text
          style={{ color: "#FE2C55", fontSize: "14px", fontWeight: 700 as any }}
        >
          Got it
        </text>
      </view>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <text
            style={{ color: "#fff", fontSize: "18px", fontWeight: 700 as any }}
          >
            ✕
          </text>
        </view>
